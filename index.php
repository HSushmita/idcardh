...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($name == '' || $id_no == ''){
        ...
        if(mysqli_num_rows($querry)>0)
        {
            ...
            $querry = mysqli_query($conn, "SELECT * FROM cards WHERE phone= '$phone' ");
            if(mysqli_num_rows($querry)>0)
            {
             $already_no = true;
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `cards`(`name`, `id_no`,  `phone`, `address`, `dob`,  `image`) VALUES ('$name','$id_no','$phone','$address','$dob','$uploadfile')"; 
      ...
      <div class="modal-content">
        ...
        <form method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="desc">Luckey Number:</label>
...
<!-- Navigation bar end  -->
  ...
  if($already_card){
    echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
    <strong>Error!</strong> Luckey number should be Unique.
    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
      <span aria-hidden='true'>×</span>
    </button>
  </div>";
  ...
  if($already_no){
    echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
    <strong>Error!</strong> This phone number is Already Added.
    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
      <span aria-hidden='true'>×</span>
    </button>
  </div>";
  ...
  <div class="card card-body">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2">
        <label for="inputZip">Group No.</label>
    ...
    <div class="form-row">
      ...
      <div class="form-row">
        <div class="form-group col-md-3">
          <label for="id_no">Luckey No.</label>
